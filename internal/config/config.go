...
type Config struct {
	...
	// the Google json file to connect with firebase. required.
	GoogleServices string `yaml:"google_services" env:"GOOGLE_SERVICES,secret"`
...
func (c Config) Validate() error {
	return validation.ValidateStruct(&c,
		validation.Field(&c.GoogleServices, validation.Required),
